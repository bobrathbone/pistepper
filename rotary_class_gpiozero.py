...
# $Id: rotary_class_gpiozero.py,v 1.1 2025/08/17 08:31:39 bob Exp $
#
# Author : Bob Rathbone
...
if __name__ == "__main__":
    ...
    def rotary_event(event):
        if event == rotaryknob.BUTTONUP or event == rotaryknob.BUTTONDOWN:
            print("rotary event",event,eventNames[event],"Mute button pressed",
                   rotaryknob.buttonPressed(knob_switch))
        else:
            print("Rotary event",event,eventNames[event])
    ...
    print("Rotary SIA switch GPIO", sia)
    print("Rotary SIB switch GPIO", sib)
    print("Rotary Knob switch GPIO", knob_switch)
