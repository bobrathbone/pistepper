...
# $Id: rotary_class.py,v 1.1 2025/08/16 06:50:54 bob Exp $
#
...
if __name__ == "__main__":
    ...
    # Get configuration
    sia = 14    # Rotary encoder sia signal
    sib = 15    # Rotary encoder sib signal
    knob_switch = 4 # Rotary encoder switch
